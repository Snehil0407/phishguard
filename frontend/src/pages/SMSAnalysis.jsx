        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            {loading || result ? (
              ...
              <div className="bg-gradient-to-br from-gray-50 to-purple-50 rounded-2xl shadow-xl p-12 border border-gray-200 flex flex-col items-center justify-center text-center h-full">
